  ...
  return (
    <>
      <SEOHead
        ...
        description="ToolVerse Terms of Service — read our terms and conditions for using our free online tools for productivity, SEO, and development."
        keywords={["terms of service", "terms and conditions", "toolverse terms", "user agreement"]}
        url="https://my-toolverse.netlify.app/terms"
      />
        ...
        <main className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground space-y-6">
            ...
            <section>
              ...
              <p>
                Permission is granted to temporarily download one copy of the materials on ToolVerse for personal,
            ...
            <section>
              ...
              <p>
                ...
                to use the materials on ToolVerse.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                Email: support@toolverse.manus.space<br />
