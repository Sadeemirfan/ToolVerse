        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "100% Free",
                  description: "All tools are completely free. No hidden charges, no premium plans, no subscriptions.",
                },
                {
                  title: "No Sign-Up Required",
                  description: "Start using tools instantly without creating an account or providing personal data.",
                },
                {
                  title: "Privacy First",
                  description: "All data processing happens in your browser. Your information never leaves your device.",
                },
                {
                  title: "Lightning Fast",
                  description: "Optimized for speed and performance. Get results instantly without waiting.",
                },
                {
                ...
                },
                {
                  ...
                  description: "Clean, distraction-free interface. We respect your privacy and browsing experience.",
                },
              ].map((feature, idx) => (
          ...
          <section>
            ...
            <p className="text-foreground/80 mb-6">
              ToolVerse offers a diverse collection of tools across multiple categories:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                { category: "SEO Tools", tools: "AI Content Detector, Meta Tag Generator" },
          ...
          <section>
            ...
            <p className="text-foreground/80 mb-6">
              ToolVerse is built using cutting-edge web technologies to ensure the best performance and user
              experience:
            </p>
            <ul className="space-y-2 text-foreground/80">
              <li className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                <span>React 19 for a responsive, dynamic user interface</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
              ...
              <li className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                <span>Client-side processing for maximum privacy and security</span>
              </li>
            </ul>
          </section>
          ...
          <section className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 rounded-lg">
            ...
            <div className="space-y-2">
              <p className="text-foreground">
                <strong>Email:</strong> support@toolverse.manus.space
              </p>
              <p className="text-foreground">
                <strong>Website:</strong> toolverse.manus.space
              </p>
            </div>
          </section>
